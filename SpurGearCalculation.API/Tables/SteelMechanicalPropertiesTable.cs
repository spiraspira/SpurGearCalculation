...
public static class SteelMechanicalPropertiesTable
{
	public static List<SteelMechanicalProperty> SteelMechanicalProperties { get; set; } = [
		...
		new SteelMechanicalProperty(SteelType.Steel45,      ProcessingType.Enhancement,          (240, 260), 850,   580),
		...
		new SteelMechanicalProperty(SteelType.Steel40X,     ProcessingType.Enhancement,          (260, 280), 950,   700),
		...
		new SteelMechanicalProperty(SteelType.Steel40XH,    ProcessingType.Enhancement,          (269, 302), 920,   750),
